...
| Prop             | Description                                                                                                                   |
|------------------|-------------------------------------------------------------------------------------------------------------------------------|
| variant          | Defines the button's style. Options are: __default__, __secondary__, __ghost__, __destructive__, __outline__, and __dashed__. |
| size             | Controls the button's size. Options are: __sm__ (small), __md__ (medium, default), and __lg__ (large).                        |
