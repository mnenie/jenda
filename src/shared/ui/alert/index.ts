...
export const variants: Record<AlertVariant, VariantChilds> = {
  ...
  success: {
    light: {
      background: 'linear-gradient(0deg, rgba(0, 255, 0, 0.05), rgba(0, 255, 0, 0.05)), #f0fff4',
  ...
  warning: {
    light: {
      background: 'linear-gradient(0deg, rgba(255, 202, 13, 0.05), rgba(255, 202, 13, 0.05)), #fff',
  ...
  important: {
    light: {
      background: 'linear-gradient(0deg, rgba(255, 0, 0, 0.05), rgba(255, 0, 0, 0.05)), #fff5f5',
