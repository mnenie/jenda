...
import type { SearchRoute } from '@/entities/search-box'
import { SearchFilter } from '@/features/filters/sidebar'
import { UiCommandDialog, UiCommandInput } from '@/shared/ui'
import { PanelItems, SearchList } from '@/entities/search-box'
