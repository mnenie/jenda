...
export const staticBtn: Record<`${ButtonPrefix}-${string}` | ButtonPrefix, string> = {
  ...
  'btn-secondary': 'bg-neutral-100 text-neutral-900 shadow-sm hover:bg-neutral-100/80 dark:(bg-neutral-800 text-neutral-50 hover:bg-neutral-800/80)',
  ...
  'btn-ghost': 'hover:(bg-neutral-100 text-neutral-900) dark:(hover:bg-neutral-700/40 hover:text-neutral-50)',
...
export const dynamicBtn: [RegExp, (params: RegExpExecArray) => string][] = [
  [/^btn-solid(?:-(.+))?$/, ([, c = '#266df0']) => `bg-${c} text-neutral-50 shadow hover:bg-${c}/90`],
