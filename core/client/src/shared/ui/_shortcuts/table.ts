...
export const staticTable: Record<`${TablePrefix}-${string}` | TablePrefix, string> = {
  ...
  'table-head': 'h-12 px-8px border-r first:border-none last:border-none border-neutral-100 dark:border-neutral-700/50 text-ellipsis text-left align-middle font-medium text-neutral-500 dark:text-neutral-400 [&:hasalign-middle [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:flex [&>[role=checkbox]]:items-center',
