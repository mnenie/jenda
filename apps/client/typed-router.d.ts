...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'boards-id': RouteRecordInfo<'boards-id', '/boards/:boardId', { boardId: ParamValue<true> }, { boardId: ParamValue<false> }>,
    'tasks-id': RouteRecordInfo<'tasks-id', '/boards/:boardId/tasks/:taskId', { boardId: ParamValue<true>, taskId: ParamValue<true> }, { boardId: ParamValue<false>, taskId: ParamValue<false> }>,
