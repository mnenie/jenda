...
export const staticAlert: Record<`${AlertPrefix}-${string}` | AlertPrefix, string> = {
  'alert': 'relative flex items-center justify-center border border-solid gap-2.5 p-3 rounded-8px mb-5 min-h-22px',
  'alert-close': 'absolute top-3 transform right-2.5 text-sm text-neutral-700 cursor-pointer dark:text-neutral-200',
  ...
  'alert-info': 'bg-blue-100 border-#266df0 text-neutral-50 dark:(bg-blue-900/40 border-#266df0 text-neutral-50)',
}
