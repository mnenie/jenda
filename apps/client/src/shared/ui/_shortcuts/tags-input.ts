...
export const staticTagsInput: Record<`${TagsInputPrefix}-${string}` | TagsInputPrefix, string> = {
  'tags-input': 'flex flex-wrap gap-2 items-center rounded-md border border-neutral-200 px-3 py-1.5 text-default dark:(border-neutral-700 focus-visible:ring-neutral-300)',
  'tags-input-input': 'text-default h-5.5 2xl:h-6 focus:outline-none flex-1 bg-transparent placeholder:text-neutral-500 dark:placeholder:text-neutral-400',
  ...
  'tags-input-item-text': 'py-0.5 px-2 text-default rounded bg-transparent',
}
