...
export const staticTabs: Record<`${TabsPrefix}-${string}` | TabsPrefix, string> = {
  ...
  'tabs-list-primary': 'relative shrink-0 flex border-b border-neutral-200',
  ...
  'tabs-trigger-primary': 'bg-white px-5 text-default h-40px flex items-center justify-center leading-none select-none rounded-tl-md outline-none cursor-default focus-visible:relative focus-visible:shadow-[0_0_0_2px] focus-visible:shadow-black',
}
