...
export const staticCommand: Record<`${CommandPrefix}-${string}` | CommandPrefix, string> = {
  ...
  'command-input': 'flex h-10 w-full rounded-md bg-transparent py-3 !text-default outline-none placeholder:text-neutral-500 disabled:(cursor-not-allowed opacity-50) dark:placeholder:text-neutral-400',
  'command-item': 'relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-default outline-none data-[highlighted]:(bg-neutral-100 text-neutral-900) data-[disabled]:(pointer-events-none opacity-50) dark:data-[highlighted]:(bg-neutral-700/40 text-neutral-50)',
  ...
  'command-shortcut': 'ml-auto text-small tracking-widest text-neutral-500 dark:text-neutral-400',
}
