...
export const staticSheet: Record<`${SheetPrefix}-${string}` | SheetPrefix, string> = {
  'sheet': 'fixed z-999 gap-4 bg-white p-6 focus:(outline-none ring-0) shadow-none transition ease-in-out dark:bg-neutral-800',
  'sheet-overlay': 'fixed inset-0 z-999 bg-black/80',
  'sheet-portal-overlay': 'sheet-overlay bg-transparent',
  ...
  'sheet-custom-header': 'dialog-custom-header py-3',
