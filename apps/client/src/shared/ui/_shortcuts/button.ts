...
export const staticBtn: Record<`${ButtonPrefix}-${string}` | ButtonPrefix, string> = {
  'btn': 'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-base 2xl:text-sm font-medium transition-colors focus-visible:(outline-none ring-1 ring-neutral-950) disabled:(pointer-events-none opacity-50) [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-neutral-300',
