export default {
  ...
  workflow: {
    ...
    node: {
      settings: {
        trigger_or_action: {
          title: 'Выберите нужный экшен для узла',
          description: 'Экшен',
          placeholder: 'Выберите из выпадающего списка...',
        },
        panel_actions: {
          column_create: 'Добавить колонку',
          column_update: 'Обновить колонку',
          column_task_create: 'Добавить задачу в колонку',
          column_delete: 'Удалить колонку',
          task_create: 'Создать задачу',
          task_update: 'Обновить задачу',
          user_add: 'Новый пользователь в команде',
          you_online: 'Вы в сети 😉',
          column_created: 'Добавлена колонка',
          column_updated: 'Колонка обновлена',
        ...
        heading: {
          ...
          description: {
            label: 'Описание',
            placeholder: 'Придумайте описание для узла...',
          },
        },
        request_body: {
        ...
        delay: {
          ...
          tooltip: 'По умолчанию 0s',
          max: 'Максимальная задержка = 1 час',
        },
    ...
    nodes: {
      ...
      items: [
        ...
        {
          title: 'HTTP Запрос',
          description: 'Интеграция с внешними сервисами через REST API',
        },
        {
          title: 'Конфетти',
  ...
  kanban: {
    empty: 'Создайте новую колонку и наслаждайтесь работой в борде',
    sorting: {
      all: 'Все задачи',
      activity: 'Aктивность',
      workload: 'Нагрузка',
    ...
    column: {
      forms: {
        settingLimit: {
          dialogTitle: 'Лимит колонки',
          dialogDescription: 'Установите лимит на количество задач в колонке.',
          limit: {
            label: 'Лимит',
            placeholder: 'Введите лимит',
          },
          errors: {
            min: 'Лимит не может быть меньше текущего количества задач - {count}',
            max: 'Лимит не может быть больше 100',
          },
        },
        edit: {
          dialogTitle: 'Редактирование колонки',
          dialogDescription: 'Вы можете редактировать название и описание колонки.',
          title: {
      ...
      remove: {
        ...
        description: 'Вы действительно хотите удалить эту колонку? Все связанные с ней данные будут удалены.',
      },
        ...
        forms: {
          creating: {
            ...
            users: {
              ...
              commandSearch: 'Добавьте исполнителей',
            },
            labels: {
              label: 'Лейблы',
  ...
  task: {
    tabs: ['Описание', 'Комментарии', 'Действия', 'Вложения'],
    comments: {
      actions: ['Скопировать ссылку', 'Редактировать', 'Удалить'],
      reply: 'Ответить',
      edit: 'редактируется | измененено',
      day: 'Сегодня | Вчера | {n} дней назад',
    ...
    attachments: {
      ...
      empty: {
        title: 'Нет вложений',
        description: 'Перетащите файлы в эту область или | выберите файлы',
      },
      alert: 'У вас доступно не более {count} файлов',
      download: {
        all: 'Скачать все',
        one: 'Скачать',
      },
      too_large: 'Выбранный файл слишком большой, пожалуйста, выберите другой',
      delete: 'Удалить',
    },
    description: {
      editor: {
    ...
    menu: {
      background: 'Выбрать обложку',
      link: 'Скопировать ссылку',
      delete: 'Удалить',
    },
    view: {
      expanded: 'Пeрейти в компактный вид',
      compact: 'Пeрейти в расширенный вид',
    },
    panel: {
      tooltip: {
        users: '{n} участника | {n} участников',
      },
    },
    remove: {
      title: 'Удаление задачи',
      description: 'Вы действительно хотите удалить эту задачу? Все связанные с ней данные будут удалены.',
    },
    copied: {
      title: 'Ссылка на задачу успешно скопирована!',
      description: 'Используйте Ctrl+V (Cmd+V для Mac) для вставки ссылки в нужное место.',
    },
  },
  welcome: {
    header: {
