...
import { notificationValues } from '../../constants/notifiction_apis'
...
<template>
  <div class="w-full flex flex-col gap-2">
    ...
    <UiFormField>
      ...
      <UtilitySelectChooser v-model="value" :items="notificationValues as Record<string, Chooser[]>" for-type="actions" class="w-320px !max-h-260px !block">
