...
declare module '@nuxt/schema' {
  interface NuxtOptions {
     ...
     */
    ["una"]: typeof import("@una-ui/nuxt").default extends NuxtModule<infer O> ? O : Record<string, any>
    /**
     ...
     */
    ["motionV"]: typeof import("motion-v/nuxt").default extends NuxtModule<infer O> ? O : Record<string, any>
    /**
  ...
  interface NuxtConfig {
     ...
     * Configuration for `@una-ui/nuxt`
     */
    ["una"]?: typeof import("@una-ui/nuxt").default extends NuxtModule<infer O> ? Partial<O> : Record<string, any>
    /**
     * Configuration for `@nuxtjs/i18n`
     */
     ...
     * Configuration for `motion-v/nuxt`
     */
    ["motionV"]?: typeof import("motion-v/nuxt").default extends NuxtModule<infer O> ? Partial<O> : Record<string, any>
    /**
     * Configuration for `@nuxt/devtools`
     */
    ...
    modules?: (undefined | null | false | NuxtModule<any> | string | [NuxtModule | string, Record<string, any>] | ["@nuxt/eslint", Exclude<NuxtConfig["eslint"], boolean>] | ["@nuxt/image", Exclude<NuxtConfig["image"], boolean>] | ["@nuxt/icon", Exclude<NuxtConfig["icon"], boolean>] | ["@nuxt/fonts", Exclude<NuxtConfig["fonts"], boolean>] | ["@unocss/nuxt", Exclude<NuxtConfig["unocss"], boolean>] | ["@nuxtjs/color-mode", Exclude<NuxtConfig["colorMode"], boolean>] | ["@vueuse/nuxt", Exclude<NuxtConfig["vueuse"], boolean>] | ["reka-ui/nuxt", Exclude<NuxtConfig["reka"], boolean>] | ["@vee-validate/nuxt", Exclude<NuxtConfig["veeValidate"], boolean>] | ["@una-ui/nuxt", Exclude<NuxtConfig["una"], boolean>] | ["@nuxtjs/i18n", Exclude<NuxtConfig["i18n"], boolean>] | ["motion-v/nuxt", Exclude<NuxtConfig["motionV"], boolean>] | ["@nuxt/devtools", Exclude<NuxtConfig["devtools"], boolean>] | ["@nuxt/telemetry", Exclude<NuxtConfig["telemetry"], boolean>])[],
  }
}
declare module 'nuxt/schema' {
  interface NuxtOptions {
